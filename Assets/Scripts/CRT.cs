...
public class CRT : MonoBehaviour
{
    ...
    [SerializeField]
    [Range(0, 2000)]
    float scanLineInterval = 500f;
    public float ScanLineInterval { get { return scanLineInterval; } set { scanLineInterval = value; } }

    [SerializeField]
    [Range(0, 2)]
    float scanLineBrightness = 0.5f;
    public float ScanLineBrightness { get { return scanLineBrightness; } set { scanLineBrightness = value; } }
    ...
    void OnRenderImage(RenderTexture src, RenderTexture dest)
    {
        ...
        material.SetFloat("_ScanLineBrightness", scanLineBrightness);
